...
public final class TestData {
    ...
    public static final Arc arc1 = Arc.createBuilder("arc1")
                       .setTarget(node1)
                       .setSource(node2)
                       .setLength(1)
    ...
    public static final Arc arc2 = Arc.createBuilder("arc2")
                       .setTarget(node2)
                       .setSource(node3)
                       .setLength(1)
    ...
    public static final Arc arc3 = Arc.createBuilder("arc3")
                       .setTarget(node3)
                       .setSource(node1)
                       .setLength(1)
    ...
    public static MetricGraph createGraph() {
        return MetricGraph.createBuilder("Graph")
                .addNode(node1)
                .addNode(node2)
                .addNode(node3)
                .addArc(arc1)
